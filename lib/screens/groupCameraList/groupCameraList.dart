...
class _GroupCameraListState extends State<GroupCameraList> {
  ...
  Widget build(BuildContext context) {
    ...
    final listLayout = GetBuilder<GroupCameraListController>(
      builder: (_) =>   Expanded(
        child:groupCameraCtrl.isLoading ?  LoadingComponent()  :   groupCameraCtrl.data != null ? ListView.builder(
          ...
          itemBuilder: (context, index) {
            return GroupCameraListCard(
              ...
              onTap: (){
                var data = {
                  'camera_groups_uuid': groupCameraCtrl.camera_groups_uuid,
    ...
    return GetBuilder<GroupCameraListController>(
      builder: (_) =>  GetBuilder<DashboardController>(
        builder: (controller) => Scaffold(
          ...
          body: Container(
            child: GroupCameraCommonScreen().body(context,cameraNameLayout,listLayout)
          ),
        ),
      ),
    );
