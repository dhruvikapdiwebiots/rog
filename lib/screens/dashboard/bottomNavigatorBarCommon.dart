...
class BottomNavigatorCard extends StatelessWidget {
  ...
  BottomNavigatorCard({Key? key, this.selectedIndex, this.onTap})
      : super(key: key);
      ...
      items: <BottomNavigationBarItem>[
        ...
        BottomNavigationBarItem(
          ...
          icon: Image.asset(
            iconAssets.shield,
            color:
                selectedIndex == 1 ? appColor.selectItemColor : appColor.grey,
        ...
        BottomNavigationBarItem(
          ...
          icon: Image.asset(
            iconAssets.settings,
            color:
                selectedIndex == 3 ? appColor.selectItemColor : appColor.grey,
